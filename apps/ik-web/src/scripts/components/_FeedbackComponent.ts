import {
  DataUtil,
  ElementStyleUtil,
  EventHandlerUtil, getAttributeValueByBreakpoint, getUniqueIdWithPrefix
} from '../_utils/index'
...
class FeedbackComponent {
  ...
  ///////////////////////
  public show = () => {
    if (EventHandlerUtil.trigger(this.element, 'st.feedback.show') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'st.feedback.shown')

    return this
  }

  public hide = () => {
    if (EventHandlerUtil.trigger(this.element, 'st.feedback.hide') === false) {
      return
    }
    ...
    this.shown = false
    EventHandlerUtil.trigger(this.element, 'st.feedback.hidden')
    return this
  }
