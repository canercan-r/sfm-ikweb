import {
  DataUtil, EventHandlerUtil, getAttributeValueByBreakpoint, getBreakpoint, getObjectPropertyValueByKey,
  getViewPort,
...
const defaultSearchQueires: ISearchQueries = {
  ...
  instanseQuery: '[data-st-search]',
  attrQuery: 'data-st-search-',
}
...
class SearchComponent {
  ...
  private _getElement = (name: string) => {
    return this.element.querySelector('[data-st-search-element="' + name + '"]')
  }
  ...
  private handlers(): void {
    ...
    if (this.menuObject) {
      ...
      if (this.toggleElement) {
        ...
        this.menuObject.on('st.menu.dropdown.show', function () {
          // @ts-ignore
        ...
        this.menuObject.on('st.menu.dropdown.hide', function () {
          // @ts-ignore
          if (isVisibleElement(context.toggleElement)) {
            // @ts-ignore
      ...
      this.menuObject.on('st.menu.dropdown.shown', function () {
        // @ts-ignore
  ...
  public search = () => {
    if (!this.processing) {
      ...
      EventHandlerUtil.trigger(this.element, 'st.search.process', this)
    }
  }
  ...
  // Clear
  public clear = () => {
    if (EventHandlerUtil.trigger(this.element, 'st.search.clear') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'st.search.cleared')
  }
