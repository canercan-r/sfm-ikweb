import {
  EventHandlerUtil, getAttributeValueByBreakpoint, getObjectPropertyValueByKey, stringSnakeToCamel, throttle
} from '../_utils/index'
...
const defaultSwapperQueires: ISwapperQueries = {
  ...
  instanseQuery: '[data-st-swapper="true"]',
  attrQuery: 'data-st-swapper-',
}
