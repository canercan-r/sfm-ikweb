import {
  DataUtil, ElementStyleUtil, getAttributeValueByBreakpoint, getCSS, getObjectPropertyValueByKey, getViewPort,
  isVisibleElement, stringSnakeToCamel, throttle
} from '../_utils/index'
...
class ScrollComponent {
  ...
  constructor(_element: HTMLElement, options: ScrollOptions) {
    ...
    this.update()
    // this.element.setAttribute('data-st-scrolltop', 'true')
    DataUtil.set(this.element, 'scroll', this)
  }

  private getOption = (name: string) => {
    if (this.element.hasAttribute('data-st-scroll-' + name) === true) {
      const attr = this.element.getAttribute('data-st-scroll-' + name) || ''
  ...
  public update = () => {
    ...
    if (
      ...
      !this.element.hasAttribute('data-st-scroll-activate')
    ) {
      this.setupHeight()
  ...
  public static destroyAll(attr: string = '[data-st-scroll="true"]') { }

  public static bootstrap(attr: string = '[data-st-scroll="true"]') {
  ...
  public static reinitialization(attr: string = '[data-st-scroll="true"]') {
    ScrollComponent.createInstances(attr)
  }

  public static updateAll() {
    const elements = document.body.querySelectorAll('[data-st-scroll="true"]')
    elements.forEach((element: Element) => {
