...
@Component({
  selector: 'ikweb-talepler',
  templateUrl: './talepler.component.html',
  styleUrl: './talepler.component.scss',
})
export class TaleplerComponent implements OnInit, AfterViewInit {
  ...
  tedarikTalebiDetayinaGit(clickEvent: IGridCellEventArgs) {
    ...
    this._router.navigate(['/tedarik/tedarik-talepleri', row.id], {
