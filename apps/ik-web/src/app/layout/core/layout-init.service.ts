...
export class LayoutInitService {
  ...
  private initHeader() {
    ...
    if (height) {
      this.bodyStyles += ` --st-header-height: ${height}px;`;
    }

    if (heightTabletAndMobile) {
      this.bodyStyles += ` --st-header-height-tablet-and-mobile: ${heightTabletAndMobile}px;`;
    }
  }
  ...
  private initPageTitle() {
    ...
    if (responsive) {
      ...
      this.layout.setHTMLAttribute('pageTitle', 'data-st-swapper-mode', 'prepend');
  ...
  private initToolbar() {
    ...
    if (type === 'toolbar1') {
      ...
      if (height) {
        this.bodyStyles += ` --st-toolbar-height: ${height}px;`;
      }

      if (heightAndTabletMobileMode) {
        this.bodyStyles += ` --st-toolbar-height-tablet-and-mobile: ${heightAndTabletMobileMode}px;`;
      }
    }
  }
  ...
  private initContent() {
    ...
    if (spacing) {
      this.bodyStyles += ` --st-content-spacing: ${spacing}px;`;
    }

    if (spacingTabletAndMobile) {
      this.bodyStyles += ` --st-content-spacing-tablet-and-mobile: ${spacingTabletAndMobile}px;`;
    }
  }
