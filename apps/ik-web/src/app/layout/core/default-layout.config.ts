...
export interface IToolbar extends ILayoutComponent {
  ...
  layouts: {
    toolbar1: {
      height: number;
      heightAndTabletMobileMode: number;
    };
    toolbar2: {
      height: number;
      heightAndTabletMobileMode: number;
...
export interface IMain extends ILayoutComponent {
  ...
  inputGroupType: IgxInputGroupType;
}
...
export const DefaultLayoutConfig: ILayout = {
  ...
  header: {
    ...
    left: 'menu',
    height: {
      desktop: 45, // ***The variables _variables.scss in the layout should change
      tabletAndMobile: 55, // ***The variables _variables.scss in the layout should change
    },
    fixed: {
  ...
  content: {
    ...
    layout: 'default',
    spacing: {
      desktop: 24, // Padding for desktop mode ***The variables _variables.scss in the layout should change
      tabletAndMobile: 16, // Padding for tablet and mobile mode ***The variables _variables.scss in the layout should change
    },
  },
  toolbar: {
    ...
    layouts: {
      toolbar1: {
        height: 50, // ***The variables _variables.scss in the layout should change
        heightAndTabletMobileMode: 50, // ***The variables _variables.scss in the layout should change
      },
      toolbar2: {
        height: 75,
        heightAndTabletMobileMode: 65,
      },
      toolbar3: {
        height: 55,
        heightAndTabletMobileMode: 55,
      },
      toolbar4: {
        height: 65,
        heightAndTabletMobileMode: 65,
