...
export class PageInfoService {
  ...
  public calculateTitle() {
    const asideTitle = this.calculateTitleInMenu('#st_aside_menu');
    const headerTitle = this.calculateTitleInMenu('#st_header_menu');
  ...
  public calculateTitleInMenu(menuId: string): string | undefined {
    ...
    ).filter((link) => link.classList.contains(this.calculateBreadcrumbsInMenu('#st_aside_menu') ? 'show' : 'active'));
  ...
  public calculateBreadcrumbs() {
    const asideBc = this.calculateBreadcrumbsInMenu('#st_aside_menu');
    const headerBc = this.calculateBreadcrumbsInMenu('#st_header_menu');
