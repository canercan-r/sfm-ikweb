import { Component, ContentChild, EventEmitter, forwardRef, Inject, Injector, Input, OnInit, Output, ViewChild } from '@angular/core';
...
import { AbsoluteScrollStrategy, AutoPositionStrategy, HorizontalAlignment, IgxSelectComponent, ISelectionEventArgs, OverlaySettings, PositionSettings, VerticalAlignment } from '@infragistics/igniteui-angular';
...
export class SelectComponent<T extends object> implements ControlValueAccessor, OnInit {
